...
type
  TfrmPrincipalBovino = class(TForm)
    ...
    rtbRelatórios: TdxRibbonTab;
    rtbGráficos: TdxRibbonTab;
    ...
    btnManejoReprodução: TdxBarButton;
    ...
    procedure btnManejoReproduçãoClick(Sender: TObject);
...
procedure TfrmPrincipalBovino.btnManejoReproduçãoClick(Sender: TObject);
begin
  TSistemaFunctions.ExecForm(TfrmMovimentacaoPropriedade, frmMovimentacaoPropriedade);
end;
